...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO reviews (ProductID, email, rating, comment, created_at) VALUES (?, ?, ?, ?, NOW())");
    $stmt->bind_param("isss", $product_id, $email, $rating, $comment);
...
$product_id = $_SESSION['ProductID'];
$sql = "SELECT email, rating, comment, created_at FROM reviews WHERE ProductID = ?";
